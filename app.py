...
# Dữ liệu cảm biến
sensor_data_buffer = deque(maxlen=200)  # mỗi phần tử: {"time": "...", "temperature":..., "humidity":...}
...
def continuous_detect():
    ...
    while detection_running:
        ...
        # FLUSH CAMERA BUFFER to get the newest frame
        for _ in range(7):   # đọc liên tục 7 lần, chỉ dùng frame cuối cùng
            ret, frame = cap.read()
        if not ret:
